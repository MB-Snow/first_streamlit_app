...
# returns the api data in JSON format so it can be displayed as a table
...
# allow the end suer to add a fruit to the list
add_my_fruit = streamlit.dataframe(my_data_rows)
